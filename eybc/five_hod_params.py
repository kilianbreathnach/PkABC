...
data = [avg_nz, avg_xi]
data_hod = np.array([1.04 , 13.38 , 0.51 , 13.94 , 13.91])
...
prior_dict = { 
    'alpha': {'shape': 'uniform', 'min': 0.9,  'max': 1.1},
    'm_min'  : {'shape': 'uniform', 'min': 13.,  'max': 13.6},   
    'sigma': {'shape': 'uniform', 'min': 0.25,  'max': .75},
    'm0': {'shape': 'uniform', 'min': 13.5,  'max': 14.5},
    'm1': {'shape': 'uniform', 'min': 13.5,  'max': 14.5}
}
...
def plot_thetas(theta , w , t): 
    ...
    plt.savefig("/home/mj/public_html/scatter_hod5_flat_t"+str(t)+".png")
    plt.close()
    np.savetxt("/home/mj/public_html/theta_hod5_flat_t"+str(t)+".dat" , theta.T)
    
    np.savetxt("/home/mj/public_html/w_hod5_flat_t"+str(t)+".dat" , w.T)
